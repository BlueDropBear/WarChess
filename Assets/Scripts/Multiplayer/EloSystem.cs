...
namespace WarChess.Multiplayer
{
    ...
    public class EloSystem
    {
        ...
        private static int GetExpectedScore1000(int ratingDiff)
        {
            ...
            // Computed from: int(1000 / (1 + 10^(-diff/400)))
            int[] table = {
                // diff: -800 to +800 in steps of 50
                 9,  13,  17,  23,  30,  40,  53,  69,  90, 117, // -800 to -350
                150, 191, 240, 296, 359, 428, 500,               // -300 to 0
                571, 640, 703, 759, 808, 849,                    // +50 to +300
                882, 909, 930, 946, 959, 969, 976, 982, 986, 990 // +350 to +800
            };
